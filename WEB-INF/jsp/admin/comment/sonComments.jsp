...
<div id="main-content" class="clearfix">
	<div id="page-content" class="clearfix">
		...
		<div class="row-fluid">
		    <form action="admin/comment/sonComment" method="get" id="basic_validate" name="basic_validate"
                <div class="control-group">
                    <label class="control-label">父评论id</label>
                    <div class="controls">
                        <input type="text" id="fatherCommentId" name="fatherCommentId" value="${fatherCommentId}" class="input-large" maxlength="50"/>
                    </div>
                </div>
                <div class="control-group">
                            ...
                            <ul>
                                <c:choose>
                                    <c:when test="${page gt 1}">
                                        <li><a
                                            href="admin/comment/sonComment?fatherCommentId=${fatherCommentId}&page=${page - 1}&status=${status}">&lt;&lt;</a></li>
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <c:choose>
                                    <c:when test="${page gt 1}">
                                        <li><a
                                            href="admin/comment/sonComment?fatherCommentId=${fatherCommentId}&page=1&status=${status}">1</a></li>
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <c:choose>
                                    <c:when test="${totalPage ge 2 and page ne 2}">
                                        <li><a
                                            href="admin/comment/sonComment?page=2&fatherCommentId=${fatherCommentId}&status=${status}">2</a></li>
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <c:choose>
                                    <c:when test="${totalPage ge 3 and page ne 3}">
                                        <li class=""><a href="admin/comment/sonComment?page=3&fatherCommentId=${fatherCommentId}&status=${status}">3</a></li>
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <c:choose>
                                    <c:when test="${page lt totalPage}">
                                        <li class="next"><a
                                            href="admin/comment/sonComment?page=${page + 1}&fatherCommentId=${fatherCommentId}&status=${status}">&gt;&gt;</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        <li class="prev disabled"><a href="javascript:void(0);">&gt;&gt;</a></li>
                                    </c:otherwise>
