...
<div id="main-content" class="clearfix">
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            <div class="row-fluid">
                <form action="admin/optActivity/updateReward" method="post" id="basic_validate" name="basic_validate" class="form-horizontal" novalidate="novalidate">
                    <div class="control-group">
                        <label class="control-label">活动名称(<font color="red">必填</font>)</label>
                        <div class="controls">
                            <input type="hidden" id="id" name="id" class="input-xlarge" value="${reward.id}"/>
                            <input type="hidden" id="activityId" name="activityId" class="input-xlarge" value="${reward.activityId}"/>
                            <input type="text" id="activityName" name="activityName" class="input-xlarge" value="${reward.activityName}" readonly/>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="rewardType" id="rewardType" style="width: 180px;">
                                    <option value="1" <c:if test="${reward.rewardType == 1}">selected</c:if>>阅读加速卡</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            <select name="realRewardId" id="realRewardId" style="width: 180px;">
                                <c:forEach items="${cards}" var="card" varStatus="st">
                                    <option value="${card.id}" <c:if test="${card.id == reward.realRewardId}"> selected</c:if>>${card.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="rewardName" name="rewardName" class="input-xlarge" value="${reward.rewardName}"/>
                        </div>
                    </div>
                            ...
                            <div class='table-pic' id="cover_table" style="float: left;">
                                <div class="table-picboxW">
                                    <div class='table-picbox'>
                                        <span><img src="${reward.rewardImage}"
                                        ...
                                        <input type="hidden" name="rewardImage" id="topic_image" value="${reward.rewardImage}" />
                                    </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="rewardCondition" name="rewardCondition" class="input-xlarge" value="${reward.rewardCondition}"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="rewardNum" name="rewardNum" class="input-xlarge" value="${reward.rewardNum}"/>
                        </div>
                    </div>
