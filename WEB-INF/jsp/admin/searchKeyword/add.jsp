            ...
            <div class="row-fluid">
                <form action="admin/searchKeywords/add" method="post" id="basic_validate" name="basic_validate" class="form-horizontal" novalidate="novalidate">
                    <div class="control-group">
                        <div class="control-label">搜索关键词(<font color="red">必填，可批量添加,以英文逗号分隔</font>)
                        <div class="controls">
                            <textarea id="keyword" name="keyword" class="input-xlarge" style="height: 100px;"  >${keyword.keyword}</textarea>
                        </div>
                        </div>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="url" name="url" class="input-xlarge" value="${keyword.url}"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="putNum" name="putNum" class="input-xlarge" value="${keyword.putNum}" placeholder="需大于0"/>
                        </div>
                    </div>
