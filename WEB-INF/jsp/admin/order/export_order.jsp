    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            <form action="#" method="post" id="basic_validate" name="basic_validate"
                ...
                <div class="control-group">
                    <label class="control-label">成功回调的</label>
                    <div class="controls">
                        <input id="need_callback" type="checkbox" />&nbsp;<span class="lbl"></span>
                    </div>
                </div>
...
<script>
    ...
    function exportorder(){
        var needCallback = "0";
        $("input:checkbox[id='need_callback']:checked").each(function(){
            needCallback = 1;
        });
        ...
        window.location.href = "admin/order/export?start_time=" + starttime + "&end_time=" + endtime + "&channel_id=" + channelId + "&callback_success=" + needCallback + "&app_id=" + selectAppId + "&app_name=" + selectAppName;;
    }
