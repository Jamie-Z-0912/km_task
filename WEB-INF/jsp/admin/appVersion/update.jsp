...
<div id="main-content" class="clearfix">
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            <div class="row-fluid">
                <form action="admin/appVersion/update" method="post" id="basic_validate" name="basic_validate" class="form-horizontal" novalidate="novalidate">
                    ...
                    <input type="hidden" id="id" name="id" class="input-large" value="${appVersion.id}"/>

                    <div class="control-group">
                        <label class="control-label">版本(如:110)</label>
                        <div class="controls">
                            <input type="text" id="version" name="version" class="input-large" value="${appVersion.version}"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input  type="hidden" name="added_time" id="start_time_hidden" value="${appVersion.addedTime}"/>
                        </div>
                    </div>
