        ...
        <div class="control-group">
            ...
            <script type="text/javascript">
                ...
                var option = {
                    ...
                    legend: {
                        data: ['领取红包人数', '共领取红包数', '人均领取红包数', '发放金币数']
                    },
                    toolbox: {
                        show: true,
                        feature: {
...
<script>
    ...
    $("#submen_tj_redpack").addClass('active');//左侧导航栏选中状态
    ...
    function query() {
        ...
        window.location.href = "admin/tj/common?eventType=receiveRedPack&start_time=" + starttime;
    }
