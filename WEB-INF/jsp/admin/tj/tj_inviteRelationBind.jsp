...
$("#submenu_bandInvite").addClass('active');//左侧导航栏选中状态
...
function query(){
    ...
    window.location.href = "admin/tj/common?eventType=inviteRelationBind&start_time=" + starttime + "&end_time=" + endtime;
}
