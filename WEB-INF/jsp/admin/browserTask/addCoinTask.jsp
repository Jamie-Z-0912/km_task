            ...
            <div class="row-fluid">
                <form action="admin/browserTask/add" method="post" id="basic_validate" name="basic_validate"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="total_count" name="total_count" value="${task.totalCount}" class="input-large" onblur="fillPrice();"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="price" name="price" class="input-large" value="${task.price}"/>
                        </div>
                    </div>
