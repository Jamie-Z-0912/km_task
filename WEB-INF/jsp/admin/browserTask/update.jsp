...
<div id="main-content" class="clearfix">
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            <form action="admin/browserTask/update" method="post" id="basic_validate" name="basic_validate"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="name" name="name"  value="${task.name}" onblur="fillShareDesc();" class="input-xxlarge"/>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="total_amount" name="total_amount" value="${task.totalAmount}" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="total_count" name="total_count"  value="${task.totalCount}" />
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="km_commission" name="km_commission" value="${task.kmCommission}" onblur="fillPrice();"/>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="price" name="price" value="${task.price}" onblur="fillKMCommission();"/>
...
<script>
    ...
    if($("#startTime").length > 0){
        $("#startTime").val(new Date(${task.startTime}).format("yyyy-MM-dd hh:mm:ss"));
        $("#endTime").val(new Date(${task.endTime}).format("yyyy-MM-dd hh:mm:ss"));
        gx();
        $("#startTime").slTime({
            callback:function(){
                gx();
